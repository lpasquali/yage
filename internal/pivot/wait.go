...
// straight copy of internal/bootstrap.waitClusterAvailable; copying instead
// of importing avoids an internal/bootstrap → internal/pivot cycle (the
// orchestrator drives pivot from bootstrap.Run).
package pivot
...
// Mirrors internal/bootstrap.waitClusterAvailable verbatim — copied to keep
// internal/pivot decoupled from internal/bootstrap.
...
// Same logic as internal/bootstrap.waitDeploymentReady; copied to avoid the
// import cycle.
